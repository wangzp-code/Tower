...
public static class UIDesignTokens
{
    ...
    {
        // 导航栏图标
        public const float NavNormal = 22f;    // 普通导航图标
        public const float NavCenter = 28f;    // 中心导航图标（闯塔）
        
        // 功能按钮图标
        public const float SideBtn = 36f;      // 侧边栏按钮
        public const float Avatar = 38f;       // 头像
        
        // 弹窗/对话框图标
        public const float DialogIcon = 36f;   // 弹窗标题图标
        public const float BestiaryIcon = 56f; // 图鉴图标
        
        // 模式选择图标
        public const float ClassIcon = 52f;    // 职业图标
    }
    ...
    {
        // 底部导航栏
        public const float NavBarHeight = 52f;      // 导航栏高度
        public const float NavLabelH = 11f;         // 导航标签高度
        public const float NavLabelFont = 8f;       // 导航标签字号
        
        // 侧边栏按钮
        public const float SideBtnSize = 44f;       // 侧边按钮尺寸
        public const float SideLabelFont = 11f;     // 侧边标签字号
        public const float SideLabelH = 14f;        // 侧边标签高度
        ...
        // 头像
        public const float AvatarSize = 38f;        // 头像尺寸
        public const float AvatarFont = 22f;        // 头像后备字号
        
        // 弹窗
        public const float DialogIconSize = 32f;    // 弹窗图标尺寸
