...
public static class UIDesignTokens
{
    ...
    {
        // 导航栏图标
        public const float NavNormal = 28f;    // 普通导航图标
        public const float NavCenter = 36f;    // 中心导航图标（闯塔）
        
        // 功能按钮图标
        public const float SideBtn = 46f;      // 侧边栏按钮
        public const float Avatar = 44f;       // 头像
        
        // 弹窗/对话框图标
        public const float DialogIcon = 40f;   // 弹窗标题图标
        public const float BestiaryIcon = 60f; // 图鉴图标
        
        // 模式选择图标
        public const float ClassIcon = 56f;    // 职业图标
    }
    ...
    {
        // 底部导航栏
        public const float NavBarHeight = 64f;      // 导航栏高度
        public const float NavLabelH = 13f;         // 导航标签高度
        public const float NavLabelFont = 10f;      // 导航标签字号
        
        // 侧边栏按钮
        public const float SideBtnSize = 56f;       // 侧边按钮尺寸
        public const float SideLabelFont = 13f;     // 侧边标签字号
        public const float SideLabelH = 16f;        // 侧边标签高度
        ...
        // 头像
        public const float AvatarSize = 44f;        // 头像尺寸
        public const float AvatarFont = 26f;        // 头像后备字号
        
        // 弹窗
        public const float DialogIconSize = 36f;    // 弹窗图标尺寸
        public const float DialogIconPad = 4f;       // 弹窗图标内边距
    }
